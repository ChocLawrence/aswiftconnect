    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 order-lg-2">
          <div class="p-5">
            <img class="img-fluid rounded-circle" src="{{ asset('assets/frontend/css/how/img/people-850097_1280.jpg')}}"
              alt="">
          </div>
        </div>
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            ...
            <p> A Lot of Africa’s youth graduate from College or Trade Schools but can’t find a job after school.
              Our dream is to provide good paying gigs in the tech sector to the highly qualified but
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="p-5">
            <img class="img-fluid rounded-circle" src="{{ asset('assets/frontend/css/how/img/opportunity.jpg')}}"
              alt="">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="p-5">
            ...
            <p>A Majority of African youth are not privileged to have access to a market that is willing to employ them
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 order-lg-2">
          <div class="p-5">
            <img class="img-fluid rounded-circle" src="{{ asset('assets/frontend/css/how/img/guy.jpg')}}" alt="">
          </div>
        </div>
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-7">Our Solution: Bridge the gap between the African Tech Sector and the rest of the World
            </h2>
            <p>With the advent of the Internet,geographical locations should and cannot contain boundaries. All what
              ...
              Connect comes in to connect these great talents with businesses and individuals looking to hire them.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="aboutus">
                ...
                <p class="aboutus-text">We believe in People first before profits. That’s our golden rule. Everything we
                  do is with the sole intention to create value for our clients and freelancers.</p>
                <p class="aboutus-text">Hiring a Freelancer on our platform is contributing to our mission of creating
                  job opportunities for the thousands of unemployed youth residing on the African Continent. That aligns
                ...
                <div class="feature-box">
                  <div class="clearfix">
                    ...
                    <div class="feature-content">
                      ...
                      <p>All our freelancers are vetted to ensure they are knowledgeable in their area of practice. So,
                        you can rest assured that you are working with an expert in his/her domain when you hire on our
                        platform.</p>
                    </div>
                  </div>
                </div><br>
                <div class="feature-box">
                  <div class="clearfix">
                    ...
                    <div class="feature-content">
                      ...
                      <p>We provide free consulting for you. We would help you define what you need for your project all
                        free of charge.</p>
                    </div>
                  </div>
                </div><br>
