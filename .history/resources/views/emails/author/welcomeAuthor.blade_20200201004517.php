...
<head>
    ...
    <title>ASwiftConnect | Welcome Author</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('assets/frontend/images/back.jpeg')}}); background-size: cover; height: 400px;">
                        <div class="overlay"></div>
                        <table>
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>You successfully registered as an employer</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            ...
                            <p>Thanks for applying to be a author on our website.You are free to post jobs at any time
                                and we will have a member of our team
                                contact you for any further proceedings.
                            </p>
