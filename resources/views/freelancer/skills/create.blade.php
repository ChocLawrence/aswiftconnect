                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="title" class="form-control" placeholder="Enter your skill" name="title" value="{{ old('title') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="skill_link" class="form-control" placeholder="Enter your skill URL" name="skill_link" value="{{ old('skill_link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
