            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                             ASSIGNED PROJECTS
                            <span class="badge bg-blue">{{ $incomplete }}</span>
                        </h2>
                    </div>
                    <div class="body">
                                    ...
                                    @foreach($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge bg-red">Incomplete</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('freelancer.post.show',$post->id) }}" class="btn btn-info waves-effect">
