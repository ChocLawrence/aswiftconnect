                    ...
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                                <img src="{{ asset('assets/frontend/images/logo.png')}}" alt="Logo" border="0" width="48"
                                    style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                            </a>
                            <h3 align="left">ASWIFTCONNECT</h3>
                        </td>
                    </tr>
                </table>
                <!--[if (gte mso 9)|(IE)]>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <strong><p>The reset token will expire in {{config('auth.passwords.users.expire')}} minutes</p></strong>    
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;"><a
                                    ...
                                    target="_blank">{{url(config('app.url').route('password.reset', $token, false))}}</a>
                            </p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> Aswiftconnect</p>
                        </td>
                    </tr>
                    <!-- end copy -->
