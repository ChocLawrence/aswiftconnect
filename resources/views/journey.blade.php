    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 order-lg-2">
          <div class="p-5">
            <img class="img-fluid rounded-circle" src="{{ asset('assets/frontend/css/how/img/people-850097_1280.jpg')}}" alt="">
          </div>
        </div>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="p-5">
            <img class="img-fluid rounded-circle" src="{{ asset('assets/frontend/css/how/img/opportunity.jpg')}}" alt="">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="p-5">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus">
                        ...
                        <p class="aboutus-text">We believe in People first before profits. That’s our golden rule. Everything we do is with the sole intention to create value for our clients and freelancers.</p>
                        <p class="aboutus-text">Hiring a Freelancer on our platform is contributing to our mission of creating job opportunities for the thousands of unemployed youth residing on the African Continent. That aligns with your company’s Corporate Social Responsibility agenda.</p>
                        ...
                        <div class="feature-box">
                            <div class="clearfix">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>All our freelancers are vetted to ensure they are knowledgeable in their area of practice. So, you can rest assured that you are working with an expert in his/her domain when you hire on our platform.</p>
                                </div>
                            </div>
                        </div><br>
                        <div class="feature-box">
                            <div class="clearfix">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>We provide free consulting for you. We would help you define what you need for your project all free of charge.</p>
                                </div>
                            </div>
                        </div><br>
                        <div class="feature-box">
