...
<head>
    ...
    <title>ASwiftConnect |Project Assigned</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <a href="{{route('home')}}"><img src="{{ asset('assets/frontend/images/logo.png')}}" alt="Logo" border="0"
                    width="48"
                    style="margin:0 auto;display: block; width:485px; max-width: 48px; min-width: 48px;padding:30px;"></a>
            <table>
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('assets/frontend/images/category-1-400x250.jpg')}}); background-size: cover; height: 400px;">
                        <div class="overlay"></div>
                        <table>
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Hello {{$post->user->name}},your project has been assigned to one of our
                                            freelancers</h2>
                                    </div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            ...
                            <p>You can check the status of the project on our site.We will be sure to keep in touch in
                                case we need more information</p>
