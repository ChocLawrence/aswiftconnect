...
<head>
    ...
    <title>ASwiftConnect | Project Complete</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <a href="{{route('landing')}}"><img src="{{ asset('assets/frontend/images/logo.png')}}" alt="Logo"
                    border="0" width="48"
                    style="margin:0 auto;display: block; width: 48px; max-width: 48px; min-width: 48px;padding:30px;"></a>
            <table>
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('assets/frontend/images/audrey-jackson-260657.jpg')}}); background-size: cover; height: 400px;">
                        <div class="overlay"></div>
                        <table>
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Hurrayy {{$post->user->name}},your project has been completed</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            ...
                            <p>Completed: {{$post->is_completed_at}}</p>
                            <p>Amount: {{$post->amount}}</p>
                            <p>We greatly appreciate our authors.The deliverables will be sent to you by mail within
                                24hours.</p>
