...
<head>
    ...
    <title>ASwiftConnect | Post Approved</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                style="margin: auto;">
                <h4 align="left">Hello {{$post->user->name}}</h4>
                <tr>
                    <td class="bg_white">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="bg_white">
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td class="bg_white email-section" width="70%">
                                                <div class="heading-section"
                                                    style="text-align: center; padding: 0 30px;">
                                                    <h2>Your post has been approved</h2>
                                                    <p>Title : {{$post->title}}</p>
                                                    <p>Your job posting have been approved.Please click on the button
                                                        below and you will be redirected to your project where you are
                                                    ...
                                                    <a href="{{url(route('author.post.show',$post->id))}}"
                                                        class="btn btn-primary">Make Payment</a>
                                                </div>
                                            </td>
                                            <td style="padding-top: 20px; padding-right: 10px;width:30%;">
                                                <div><img src="{{ asset('assets/frontend/images/destination-1.jpg')}}"
                                                        alt=""
                                                ...
                                                <div class="text-tour" style="text-align: center;">
                                                    ...
                                                    <p>Some of our freelancers come from here</p>
                                                </div>
                                            </td>
                                        </tr><!-- end: tr -->
