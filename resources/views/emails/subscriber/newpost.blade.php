...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
        <!-- BEGIN BODY -->
		<span>Hello  <a href="{{route('home')}}"><img src="{{ asset('assets/frontend/images/logo.png')}}" alt="Logo" border="0" width="48"
			style="display: block; width:485px; max-width: 48px; min-width: 48px;"></a></span>
		<h4>A new Post is Available on AswiftConnect</h4>
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody><tr>
                <td>
                  <img src="{{ asset('assets/frontend/images/bg_2.jpg')}}" alt="" style="width: 100%; max-width: 600px; height: auto; margin: auto; display: block;">
                </td>
              </tr>
            </tbody></table>
          </td>
                ...
                <td class="text-services" style="text-align: left; padding-left:25px;">
                    <div class="heading-section">
                                    ...
                                    <div class="services-list">
                                        <div class="text">
                                            <h3>1. Take a Look</h3>
                                            <p>Might concern some skills you want to develop</p>
                                        </div>
                                    </div>
                                    <div class="services-list">
                                        <div class="text">
                                            <h3>2. Search for Freelancers</h3>
                                            <p>You can share on social Media so freelancers can apply</p>
                                        </div>
                                    </div>
                                    <div class="services-list">
                                        <div class="text">
                                            <h3>3. Reach out to us</h3>
                                            <p>Like the project and reach out to us if you are interested</p>
                                        </div>
                                    </div>
                                    <div class="services-list">
                                      <p><a href="{{route('home')}}" class="btn btn-primary">View Post</a></p>
                                    </div>
                </td>
              </tr>
            </tbody>
