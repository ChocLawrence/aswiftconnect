...
<head>
    ...
    <title>ASwiftConnect | New Post</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <table>
                <tr>
                    <td>
                        <h4>A new Post needs Approval</h4>
                    </td>
                    <td><a href="{{route('landing')}}"><img src="{{ asset('assets/frontend/images/logo.png')}}"
                ...
                <tbody>
                    <tr>
                        ...
                        <td valign="middle" width="50%">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tbody>
                                    <p><a href="{{url(route('admin.post.show',$post->id))}}" class="btn btn-primary">Go
                                            to Post</a></p>
                                </tbody>
                            </table>
                        </td>
