...
<head>
    ...
    <title>ASwiftConnect | Project Complete</title>
            ...
            <table>
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('assets/frontend/images/bg_2.jpg')}}); background-size: cover; height: 400px;">
                        <div class="overlay"></div>
                        <table>
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Congratulations {{$freelancer->name}} on Completing this project</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            ...
                            <p>Earnings: {{$post->earning}}</p>
                            <p>We greatly appreciate our freelancers and are working very hard to keep all of you busy
                                while earning..
                                Expect to receive your payment within 2 business days from today.</p>

                            <p><a href="{{route('landing')}}" class="btn btn-primary">Continue Liking Projects</a></p>   
