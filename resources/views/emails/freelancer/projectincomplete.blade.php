...
<head>
    ...
    <title>ASwiftConnect | Project InComplete</title>
                    ...
                    <table>
                        <tr>
                            <td valign="middle" class="hero bg_white"
                                style="background-image: url({{ asset('assets/frontend/images/alex-lambley-205711.jpg')}}); background-size: cover; height: 400px;">
                                <div class="overlay"></div>
                                <table>
                                    <tr>
                                        <td>
                                            <div class="text" style="text-align: center;">
                                                <h2>Hello {{$freelancer->name}},your project has been marked incomplete</h2>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <h2>We are glad to have you on our platform</h2>
                                    <p>Title : {{$post->title}}</p>
                                    <p>Deadline for Freelancer: {{$post->deadline}}</p>
                                    <p>Thanks for working on the job. We do understand that sometimes things don\'t go as
                                        planned.
                                        Based off the client feedback, he was not satisfied with the job you did on this
                                        project.
                                        Situations like these, affect our profitability and the trust our clients have in us.
                                        We do have a 2 strike rule, which was in the agreement you signed before joining our
                                        platform.
                                        Based off that, you have one more strike before we will unfortunately have to deactivate
                                        your account on our platform. Hopefully,
                                        that never happens. As always we available to help out if you need anything.</p>
                                    <a href="{{url(route('landing'))}}"
                                    class="btn btn-primary">Go To Site</a>    
