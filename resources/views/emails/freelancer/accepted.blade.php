...
<head>
    ...
    <title>ASwiftConnect | Accepted</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<body width="100%" style="margin: 0; padding: 0 !important; mso--height-rule: exactly; background-color: #222222;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Congratulations {{$freelancer->name}},your interview was successful</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            <h2>We are glad to welcome you on our platform</h2>
                            <p>Congratulations on successfully passing our vetting process. You are now part of a
                                growing community of the world\'s top tech and design freelancers.
                                We work hard to keep our freelancers busy. Below is a link to go ahead and modify your
                                profile and share your past projects you have worked on in your about section.
                                We also value referrals from our freelancers.
                                For every freelancer you refer to us and who passes our vetting process, you will get a
                                $20 Amazon Gift Card. We wish you success on this new journey with us.
                                Get started and look through some job postings
                            </p>
                            <p><a href="{{ route('landing')}}" class="btn btn-primary">Get Started</a></p>
