                            ...
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Hey {{$freelancer->name}},your interview was unsuccessful</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            <h2>Thanks for applying to be a freelancer with us.</h2>
                            <p>Unfortunately you were not successful in passing our vetting process. <br>
                                Try again another time after improving on the skill set you were lacking<br>
                                You can check our site to see the fields you can target
                            </p>
                            <p><a href="{{ url('/')}}" class="btn btn-secondary">Go to Site</a></p>
