...
<head>
    ...
    <title>ASwiftConnect | Resume Received</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('assets/frontend/images/ben-o-sullivan-382817.jpg')}}); background-size: cover; height: 400px;">
                        <div class="overlay"></div>
                        <table>
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2>Your Resume has been received</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_dark email-section" style="text-align:center;">
                        <div class="heading-section heading-section-white">
                            <h2>Name : {{$freelancer->name}}</h2>
                            <h2>Email : {{$freelancer->email}}</h2>
                            <p>Thanks for applying to be a freelancer on our website. A member of our team would be in touch with you within 24 hours.</p>
