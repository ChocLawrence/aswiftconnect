...
<head>
    ...
    <title>ASwiftConnect | Assigned</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <table>
                <tr>
                    <td valign="middle" class="counter"
                        style="background-image: url({{ asset('assets/frontend/images/ben-o-sullivan-382817.jpg')}}); background-size: cover; padding: 4em 0;">
                            ...
                            <tr>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td class="counter-text">
                                                <span class="num">Congrats, you got a project</span>
                                                <span class="name">Hurraayy</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td valign="middle" width="33.333%">
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td class="counter-text">
                                                <span class="num">Deadline</span>
                                                <span class="name">{{$post->deadline}}</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td valign="middle" width="33.333%">
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td class="counter-text">
                                                <span class="num">Earnings</span>
                                                <span class="name">$ {{$post->earning}}</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <tr>
                        <td class="bg_white email-section">
                            <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                <h2>Hello {{$freelancer->name}},you have been assigned a project</h2>
                                <p>With this project, we will monitor the quality of your work and it will earn you much
                                    more projects if you do well</p>
                                <p>Reply us with a time slot in GMT to schedule a call with you, to go over the job
                                    specifics.</p>
                                <p>Not hearing from you within 24 hours will mean you are not available and policy
                                    requires us to assign another freelancer</p>
                                <p>We are counting on you.</p>
                                <p><a href="{{url(route('freelancer.post.show',$post->id))}}" class="btn btn-primary">See Project</a></p>
                            </div>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="10" border="0"
                                            ...
                                            <tr>
                                                <td class="text-services" style="text-align: left;">
                                                    ...
                                                    <p>Our freelancers are all around the world </p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td valign="top" width="50%" style="padding-top: 20px;">
                                        <table role="presentation" cellspacing="0" cellpadding="10" border="0"
                                            ...
                                            <tr>
                                                <td class="text-services" style="text-align: left;">
                                                    <h3>Freedom</h3>
                                                    <p>Far far away, behind the great mountains, they all thrive. </p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
