...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $freelancer_count = User::where('role_id',3)->count();
       ...
       $tag_count = Tag::all()->count();
        ...
        return view('admin.dashboard',compact('posts','popular_posts','total_pending_posts','all_views','author_count','freelancer_count','new_authors_today','active_authors','category_count','tag_count'));
    }
}
